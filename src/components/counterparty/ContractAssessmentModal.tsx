...
export const RISKS: ContractRisk[] = [
  {
    ...
    title: "Одностороннее повышение стоимости услуг",
    description:
      "Контрагент вправе в одностороннем порядке повышать стоимость услуг, просто уведомив об этом за 30 дней. Купер (Инстамарт Сервис) не может заблокировать рост цен, что создает риск выхода расходов за пределы утвержденного бюджета.",
  },
  {
    id: "m-1",
    level: "medium",
    category: "Риски контрагентов",
    title: "Отказ в возмещении ущерба за порчу груза",
    description:
      "Контрагент не отвечает за порчу товара внутри упаковки, если сама коробка не повреждена. Купер (Инстамарт Сервис) понесет финансовые потери за испорченный товар, так как доказать вину перевозчика при целой упаковке невозможно.",
  },
  {
    id: "m-2",
    level: "medium",
    category: "Процессные риски",
    title: "Оплата услуг на основании данных исполнителя",
    description:
      "При расхождении в расчетах приоритет имеют данные системы контрагента, а не Купер (Инстамарт Сервис). Из-за короткого срока на проверку есть риск автоматически оплатить ошибочные суммы, которые сложно будет вернуть.",
  },
];
